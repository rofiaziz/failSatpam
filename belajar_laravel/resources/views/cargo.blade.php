...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/cargo/fonts/icomoon/style.css">

    <link rel="stylesheet" type="text/css" href="/cargo/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/cargo/css/jquery.fancybox.min.css">
    <link rel="stylesheet" type="text/css" href="/cargo/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="/cargo/css/owl.theme.default.min.css">
    <link rel="stylesheet" type="text/css" href="/cargo/fonts/flaticon/font/flaticon.css">
    <link rel="stylesheet" type="text/css" href="/cargo/css/aos.css">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
          ...
          <div class="owl-carousel nonloop-block-13">
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <figure>
                  <img src="/cargo/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle mx-auto">
                </figure>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-5 d-flex blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="#" class="blog-thumbnail"><img src="/cargo/images/cargo_sea_small.jpg" alt="Image" class="img-fluid"></a>
                <div class="blog-excerpt">
                  <span class="d-block text-muted">Apr 19, 2019</span>
                  <h2 class="h4  mb-3"><a href="/cargo/single.html">Knowing the Difference Is Key to Effective Logistics</a></h2>

                  <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p>
                  <p><a href="/cargo/single.html" class="text-primary">Read More</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="mb-5 d-flex blog-entry" data-aos="fade-right" data-aos-delay="">
                <a href="#" class="blog-thumbnail"><img src="cargo/images/cargo_air_small.jpg" alt="Image" class="img-fluid"></a>
                <div class="blog-excerpt">
                  <span class="d-block text-muted">Apr 19, 2019</span>
                  <h2 class="h4  mb-3"><a href="/cargo/single.html">Knowing the Difference Is Key to Effective Logistics</a></h2>
    ...
    <script type="text/javascript" src="/cargo/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="/cargo/js/popper.min.js"></script>
    <script type="text/javascript" src="/cargo/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/cargo/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="/cargo/js/jquery.sticky.js"></script>
    <script type="text/javascript" src="/cargo/js/jquery.waypoints.min.js"></script>
    <script type="text/javascript" src="/cargo/js/jquery.animateNumber.min.js"></script>
    <script type="text/javascript" src="/cargo/js/jquery.fancybox.min.js"></script>
    <script type="text/javascript" src="/cargo/js/jquery.easing.1.3.js"></script>
    <script type="text/javascript" src="/cargo/js/aos.js"></script>

    <script type="text/javascript" src="/cargo/js/main.js"></script>
